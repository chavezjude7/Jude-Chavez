...
try {
	 ...
	 **/
	$recipients = ["chavezjude7@gmail.com" => "Jude Chavez"];
	...
	echo "<div class=\"alert alert-success\" role=\"alert\">Got it dude!</div>";
} catch(Exception $exception) {
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>Bruhhh!</strong> Unable to send email: " . $exception->getMessage() . "</div>";
}